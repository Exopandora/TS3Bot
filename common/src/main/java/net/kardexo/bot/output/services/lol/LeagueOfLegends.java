...
public class LeagueOfLegends {
	...
	public static final URI STATIC_DOC_API_URL = URI.create("https://static.developer.riotgames.com/docs/");
	...
	public static JsonNode fetchMatchHistory(
	...
	public static JsonNode fetchChampionMastery(
		IAPIKeyService apiKeyService,
		String puuid,
		long championId,
		Platform platform
