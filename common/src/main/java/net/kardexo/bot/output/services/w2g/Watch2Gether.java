package net.kardexo.bot.output.services.w2g;
...
public class Watch2Gether {
	...
	private static final SimpleCommandExceptionType WATCH2GETHER_SERVICE_UNAVAILABLE =
		new SimpleCommandExceptionType(new LiteralMessage("Watch2Gether is currently unavailable"));
	
	public static JsonNode createRoom(
