package net.kardexo.bot.output.services.twitter;
...
public class Twitter {
	...
	private static final SimpleCommandExceptionType ERROR_LOADING_STATUS =
		new SimpleCommandExceptionType(new LiteralMessage("Error loading status"));
	private static final SimpleCommandExceptionType ERROR_LOADING_PROFILE =
		new SimpleCommandExceptionType(new LiteralMessage("Error loading profile"));
