package net.kardexo.bot.input;

import net.kardexo.bot.api.IAPIKeyService;
import net.kardexo.bot.api.IBonusService;
...
import net.kardexo.bot.domain.services.APIKeyService;
import net.kardexo.bot.domain.services.BonusService;
import net.kardexo.bot.domain.services.ConfigService;
import net.kardexo.bot.domain.services.EconomyService;
import net.kardexo.bot.domain.services.MessageService;
import net.kardexo.bot.domain.services.PermissionService;
import net.kardexo.bot.domain.services.UserConfigService;
