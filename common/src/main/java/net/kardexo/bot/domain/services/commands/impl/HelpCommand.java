...
public class HelpCommand {
	private static final DynamicCommandExceptionType UNKNOWN_COMMAND =
		new DynamicCommandExceptionType(command -> new LiteralMessage("Unknown command " + command));
	...
	public static void appendAllUsage(
		StringBuilder builder,
		CommandDispatcher<CommandSource> dispatcher,
		List<CommandNode<CommandSource>> nodes,
