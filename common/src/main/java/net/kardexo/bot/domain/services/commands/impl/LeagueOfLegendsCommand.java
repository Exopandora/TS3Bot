...
import net.kardexo.bot.domain.chat.FormattedStringBuilder;
...
import net.kardexo.bot.domain.services.commands.arguments.RiotIdArgumentType;
import net.kardexo.bot.output.services.lol.League;
import net.kardexo.bot.output.services.lol.LeagueOfLegends;
