...
import net.kardexo.bot.domain.commands.arguments.ChannelArgumentType;
import net.kardexo.bot.domain.services.commands.Commands;

public class MoveCommand {
	private static final DynamicCommandExceptionType UNABLE_TO_JOIN_CHANNEL =
		new DynamicCommandExceptionType(channel -> new LiteralMessage("Unable to join channel " + channel));
