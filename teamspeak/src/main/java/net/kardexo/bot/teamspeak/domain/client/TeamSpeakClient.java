...
public class TeamSpeakClient implements IClient {
	protected final TS3Api api;
	protected final int clientId;
	private String uniqueId;
	
	public TeamSpeakClient(TS3Api api, int clientId) {
		this.api = api;
	...
	public IChannel getChannel() {
		return new TeamSpeakMessageChannel(this.api, this.api.getClientInfo(this.clientId).getChannelId());
	}
	
	@Override
	public boolean equals(Object object) {
		if (!(object instanceof TeamSpeakClient other)) {
			return false;
		}
